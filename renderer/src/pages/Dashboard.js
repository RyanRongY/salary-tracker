...
const Dashboard = () => {
    ...
    return (_jsx("div", { style: {
            ...
            textAlign: "center",
            position: "relative",
        }, children: isWorking ? (_jsxs(_Fragment, { children: [_jsx(Title, { level: 4, children: "\u4EE8\u74DC\u4FE9\u67A3\u8BA1\u7B97\u5668" }), _jsxs(Title, { level: 3, style: { color: config.themeColor }, children: [earnings.toFixed(2), " ", config.currency] }), _jsx(Progress, { percent: progress, status: "active", strokeColor: config.themeColor, format: (p) => `${p?.toFixed(1)}%` })] })) : (_jsxs(_Fragment, { children: [_jsx(Title, { level: 4, style: { color: "green" }, children: "\u5DF2\u4E0B\u73ED \uD83C\uDF89" }), _jsx(Text, { children: "\u4ECA\u65E5\u603B\u6536\u5165\uFF1A" }), _jsxs(Title, { level: 3, style: { color: config.themeColor }, children: [earnings.toFixed(2), " ", config.currency] })] })) }));
};
